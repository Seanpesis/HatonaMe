// Simple JSON database for local development and Netlify Functions
const fs = require('fs');
const path = require('path');

// Database file path - use local file for development, /tmp for Netlify
const DB_FILE = process.env.NODE_ENV === 'production' 
  ? '/tmp/wedding_database.json' 
  : path.join(__dirname, 'wedding_database.json');
